...
export const ConverterSection = ({ onCopy }: ConverterSectionProps) => {
  ...
  const handleDateChange = (value: string) => {
    ...
    if (ms === null) {
      setError(t('converter.error.invalidDate'));
      return;
    }
      ...
      <div className="space-y-6">
          ...
          <div className="flex gap-2">
            <div className="flex-1 relative">
              <input
                ...
                placeholder={t('converter.epochPlaceholder')}
                ...
                aria-label={t('converter.epochLabel')}
              />
            ...
            <button
              ...
              aria-label={t('converter.copyEpoch')}
            >
          ...
          <div className="flex gap-2">
            <div className="flex-1">
              <input
                ...
                placeholder={t('converter.localPlaceholder')}
                className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-white transition-colors"
                aria-label={t('converter.localDateTime')}
                readOnly
              />
            </div>
            <button
              ...
              className="px-4 py-3 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg transition-colors"
              aria-label={t('converter.copyLocal')}
            >
              <Copy className="w-5 h-5" />
            </button>
          </div>
          ...
          <div className="flex gap-2">
            <div className="flex-1">
              <input
                ...
                aria-label={t('converter.utcDateTime')}
              />
            </div>
            <button
              onClick={() => onCopy(getUTCDate())}
              className="px-4 py-3 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg transition-colors"
              aria-label={t('converter.copyUtc')}
            >
              <Copy className="w-5 h-5" />
            </button>
          </div>
        ...
        <div className="space-y-4">
          <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <p className="text-xs text-gray-500 dark:text-gray-500">{t('converter.description')}</p>
          </div>
        </div>
